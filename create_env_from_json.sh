...
if [ ! -f "$INPUT_JSON_FILE" ]; then
  echo "❌ Error: Input file not found at '$INPUT_JSON_FILE'"
  exit 1
fi
...
echo "📝 Writing encoded content to '$OUTPUT_ENV_FILE'..."
...
echo "✅ Success! Encoded content saved to '$OUTPUT_ENV_FILE'."
echo "➡️ Next steps:"
